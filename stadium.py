...
stadiums = [
    ...
    ['Memorial Stadium'],
    ['Mercedes-Benz Superdome', 'Mercedez-Benz Superdome', 'Louisiana Superdome','Mercedes Benz-Superdome'],
    ...
    ['NRG Stadium', 'NRG Stadiium', 'NRG', 'NRG STADIUM', 'nrg Stadium', 'Reliant Stadium', 'Reliant'],
    ...
    ['Ralph Wilson Stadium', 'Ralph Wilson', 'Rich Stadium', 'The Stadium', 'The Stadium, Orchard Park NY', 'New Era Field'],
    ['Raymond James Stadium', 'Raymond James', 'Raymond James STadium', 'Raymond James, Tampa, Florida', 'Raymon James Stadium'],
    ['Rogers Centre'],
    ['Ross-Ade Stadium'],
    ...
    ['Sun Life Stadium', 'SunLife Stadium', 'Pro Player Stadium', 'Pro Player', 'Dolphin Stadium', 'Dolphins Stadium', 'Land Shark Stadium', 'Hard Rock Stadium'],
